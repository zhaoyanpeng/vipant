...
from .loss_more import (
    LMLossHead, BCELossHead, JaxBCELossHead, BCHingeLossHead, BCEAndCELossHead, ImaginedCLFLossHead, ImagineAndClassifyLossHead
)
LOSS_HEADS_REGISTRY.register(LMLossHead)
LOSS_HEADS_REGISTRY.register(BCELossHead)
LOSS_HEADS_REGISTRY.register(JaxBCELossHead)
